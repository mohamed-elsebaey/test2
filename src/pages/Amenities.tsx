...
import { Sparkles, Dumbbell, Waves, Activity, Utensils, Wine, Coffee, Clock, Car, Plane, Car as CarIcon, MapPin, Music, Users, BookOpen } from "lucide-react";
...
export default function Amenities() {
  ...
  const getIcon = (categoryName: string, index: number) => {
    const icons = {
      wellness: [<Sparkles key={0} />, <Dumbbell key={1} />, <Waves key={2} />, <Activity key={3} />],
